            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div className="text-center">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <ScrollToTest />
                        <a href="https://pubmed.ncbi.nlm.nih.gov/36725582/#:~:text=Abstract,testing%20robustness%20of%20thermal%20conductivity." className="text-sm font-semibold leading-6 text-gray-900">About the Ångström method <span aria-hidden="true">→</span></a>
                    </div>
                </div>
            </div>
